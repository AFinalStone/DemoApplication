...
package com.shi.androidstudy.view.charting.charts;
...
import com.shi.androidstudy.view.charting.components.XAxis;
import com.shi.androidstudy.view.charting.data.PieData;
import com.shi.androidstudy.view.charting.highlight.Highlight;
import com.shi.androidstudy.view.charting.highlight.PieHighlighter;
import com.shi.androidstudy.view.charting.interfaces.datasets.IPieDataSet;
import com.shi.androidstudy.view.charting.renderer.PieChartRenderer;
import com.shi.androidstudy.view.charting.utils.MPPointF;
import com.shi.androidstudy.view.charting.utils.Utils;

import java.util.List;

/**
 * View that represents a menu_circle chart. Draws cake like slices.
 *
...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    /**
     * array that holds the width of each menu_circle-slice in degrees
     */
    ...
    /**
     * variable for the text that is drawn in the center of the menu_circle-chart
     */
    ...
    public void calculateOffsets() {
        ...
        // create the circle box that will contain the menu_circle-chart (the bounds of
        // the menu_circle-chart)
    ...
    /**
     * set this to true to draw the menu_circle center empty
     *
     * @param enabled
     */
    ...
    /**
     * returns true if the hole in the center of the menu_circle-chart is set to be
    ...
    /**
     * returns the text that is drawn in the center of the menu_circle-chart
     *
     * @return
     */
    ...
    /**
     * returns the circlebox, the boundingbox of the menu_circle-chart slices
     *
     * @return
     */
    ...
    /**
     * Set this to true to draw the entry labels into the menu_circle slices (Provided by the getLabel() method of the PieEntry class).
    ...
    /**
     * Returns true if the chart is set to draw each end of a menu_circle-slice
     * "rounded".
     *
     * @return
     */
    ...
    /**
     * the rectangular radius of the bounding box for the center text, as a percentage of the menu_circle
     * hole
     * default 1.f (100%)
     */
    ...
    /**
     * Sets the max angle that is used for calculating the menu_circle-circle. 360f means
     * it's a full PieChart, 180f results in a half-menu_circle-chart. Default: 360f
     *
