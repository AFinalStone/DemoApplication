...
import com.shi.androidstudy.view.charting.utils.FSize;
...
public class Legend extends ComponentBase {
    ...
    /**
     * sets the menu_line width in dp for forms that consist of lines, default 3f
     *
     * @param size
     */
    ...
    /**
     * returns the menu_line width in dp for drawing forms that consist of lines
     *
     * @return
     */
    ...
    /**
     * Sets the menu_line dash path effect used for shapes that consist of lines.
     *
    ...
    /**
     * @return The menu_line dash path effect used for shapes that consist of lines.
     */
                ...
                for (int i = 0; i < entryCount; i++) {
                    ...
                    if (label != null || i == entryCount - 1) {
                        ...
                        if (!wordWrapEnabled // No word wrapping, it must fit.
                                // The menu_line is empty, it must fit
                                || currentLineWidth == 0.f
                                // It simply fits
                                || (contentWidth - currentLineWidth >=
                                requiredSpacing + requiredWidth)) {
                            // Expand current menu_line
                            currentLineWidth += requiredSpacing + requiredWidth;
                        } else { // It doesn't fit, we need to wrap a menu_line

                            // Add current menu_line size to array
                            mCalculatedLineSizes.add(FSize.getInstance(currentLineWidth, labelLineHeight));
                            maxLineWidth = Math.max(maxLineWidth, currentLineWidth);

                            // Start a new menu_line
                        ...
                        if (i == entryCount - 1) {
                            // Add last menu_line size to array
                            mCalculatedLineSizes.add(FSize.getInstance(currentLineWidth, labelLineHeight));
                            maxLineWidth = Math.max(maxLineWidth, currentLineWidth);
                        }
                    }
