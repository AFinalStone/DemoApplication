...
public class FileUtils {
    ...
    public static List<Entry> loadEntriesFromFile(String path) {
        ...
        // @SuppressWarnings("resource")
        // BufferedReader br = new BufferedReader(new FileReader(file));
        // String menu_line = br.readLine();
        //
        // // firstline is the label
        // label = menu_line;
        //
        // while ((menu_line = br.readLine()) != null) {
        // String[] split = menu_line.split("#");
    ...
    public static List<Entry> loadEntriesFromAssets(AssetManager am, String path) {
        ...
        // String menu_line = reader.readLine();
        //
        // while (menu_line != null) {
        // // process menu_line
        // String[] split = menu_line.split("#");
        // entries.add(new Entry(Float.parseFloat(split[0]),
        // Integer.parseInt(split[1])));
        // menu_line = reader.readLine();
        // }
        // } catch (IOException e) {
        // Log.e(LOG, e.toString());
        //
