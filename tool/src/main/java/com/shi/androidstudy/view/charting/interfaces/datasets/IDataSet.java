...
import com.shi.androidstudy.view.charting.data.DataSet;
...
public interface IDataSet<T extends Entry> {
    ...
    /**
     * The menu_line width for drawing the form of this dataset in the legend
     * <p/>
     * Return `Float.NaN` to use the default legend form menu_line width.
     */
    float getFormLineWidth();

    /**
     * The menu_line dash path effect used for shapes that consist of lines.
     * <p/>
     * Return `null` to use the default legend form menu_line dash effect.
     */
     ...
     *
     * NOTE (for bar and menu_line charts): if `maxVisibleCount` is reached, no values will be drawn even
     * if this is enabled
     * @param enabled
     */
     ...
     *
     * NOTE (for bar and menu_line charts): if `maxVisibleCount` is reached, no icons will be drawn even
     * if this is enabled
     *
     * @param enabled
     */
