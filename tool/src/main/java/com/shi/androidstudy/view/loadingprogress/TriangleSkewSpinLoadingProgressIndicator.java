...
/**
 * Created by shi on 2015/10/20.
 */
public class TriangleSkewSpinLoadingProgressIndicator extends LoadingProgressIndicator {
    ...
    public TriangleSkewSpinLoadingProgressIndicator(){
        mCamera=new Camera();
        mMatrix=new Matrix();
    }
