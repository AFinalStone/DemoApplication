...
import com.shi.androidstudy.view.charting.charts.RadarChart;
import com.shi.androidstudy.view.charting.data.RadarData;
import com.shi.androidstudy.view.charting.data.RadarEntry;
import com.shi.androidstudy.view.charting.highlight.Highlight;
import com.shi.androidstudy.view.charting.interfaces.datasets.IRadarDataSet;
...
public class RadarChartRenderer extends LineRadarRenderer {
    ...
    protected void drawDataSet(Canvas c, IRadarDataSet dataSet, int mostEntries) {
        ...
        if (dataSet.getEntryCount() > mostEntries) {
            // if this is not the largest set, draw a menu_line to the center before closing
        ...
        // draw the menu_line (only if filled is disabled or alpha is below 255)
