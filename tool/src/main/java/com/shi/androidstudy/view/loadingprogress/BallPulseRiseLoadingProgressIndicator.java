...
/**
 * Created by shi on 2015/10/17.
 */
public class BallPulseRiseLoadingProgressIndicator extends LoadingProgressIndicator {
    ...
    public BallPulseRiseLoadingProgressIndicator(){
        mCamera=new Camera();
        mMatrix=new Matrix();
    }
