...
/**
 * The limit menu_line is an additional feature for all Line-, Bar- and
 * ScatterCharts. It allows the displaying of an additional menu_line in the chart
...
public class LimitLine extends ComponentBase {
    ...
    /** the width of the limit menu_line */
    private float mLineWidth = 2f;

    /** the color of the limit menu_line */
    private int mLineColor = Color.rgb(237, 91, 91);

    /** the style of the label text */
    private Paint.Style mTextStyle = Paint.Style.FILL_AND_STROKE;

    /** label string that is drawn next to the limit menu_line */
     ...
     *            (xIndex) where this menu_line should appear
     */
    ...
    /**
     * Returns the limit that is set for this menu_line.
     * 
     * @return
     */
    ...
    /**
     * set the menu_line width of the chart (min = 0.2f, max = 12f); default 2f NOTE:
     * thinner menu_line == better performance, thicker menu_line == worse performance
     * 
     * @param width
     */
    ...
    /**
     * returns the width of limit menu_line
     * 
     * @return
     */
    ...
    /**
     * Enables the menu_line to be drawn in dashed mode, e.g. like this "- - - - - -"
     * 
    ...
    /**
     * Disables the menu_line to be drawn in dashed mode.
     */
    ...
    /**
     * Returns true if the dashed-menu_line effect is enabled, false if not. Default:
     * disabled
     * 
     * @return
     */
    ...
    /**
     * Sets the label that is drawn next to the limit menu_line. Provide "" if no
     * label is required.
     * 
     * @param label
     */
    ...
    /**
     * Returns the label that is drawn next to the limit menu_line.
     * 
     * @return
     */
