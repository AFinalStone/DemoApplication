package com.shi.androidstudy.view.slider;
...
import com.shi.androidstudy.view.slider.Animations.BaseAnimationInterface;
import com.shi.androidstudy.view.slider.Indicators.PagerIndicator;
import com.shi.androidstudy.view.slider.SliderTypes.BaseSliderView;
import com.shi.androidstudy.view.slider.Transformers.AccordionTransformer;
import com.shi.androidstudy.view.slider.Transformers.BackgroundToForegroundTransformer;
import com.shi.androidstudy.view.slider.Transformers.BaseTransformer;
import com.shi.androidstudy.view.slider.Transformers.CubeInTransformer;
import com.shi.androidstudy.view.slider.Transformers.DefaultTransformer;
import com.shi.androidstudy.view.slider.Transformers.DepthPageTransformer;
import com.shi.androidstudy.view.slider.Transformers.FadeTransformer;
import com.shi.androidstudy.view.slider.Transformers.FlipHorizontalTransformer;
import com.shi.androidstudy.view.slider.Transformers.FlipPageViewTransformer;
import com.shi.androidstudy.view.slider.Transformers.ForegroundToBackgroundTransformer;
import com.shi.androidstudy.view.slider.Transformers.RotateDownTransformer;
import com.shi.androidstudy.view.slider.Transformers.RotateUpTransformer;
import com.shi.androidstudy.view.slider.Transformers.StackTransformer;
import com.shi.androidstudy.view.slider.Transformers.TabletTransformer;
import com.shi.androidstudy.view.slider.Transformers.ZoomInTransformer;
import com.shi.androidstudy.view.slider.Transformers.ZoomOutSlideTransformer;
import com.shi.androidstudy.view.slider.Transformers.ZoomOutTransformer;
import com.shi.androidstudy.view.slider.Tricks.FixedSpeedScroller;
import com.shi.androidstudy.view.slider.Tricks.InfinitePagerAdapter;
import com.shi.androidstudy.view.slider.Tricks.InfiniteViewPager;
import com.shi.androidstudy.view.slider.Tricks.ViewPagerEx;
...
public class SliderLayout extends RelativeLayout {
    ...
    /**
     * A timer and a TimerTask using to cycle the {@link com.shi.androidstudy.view.slider.Tricks.ViewPagerEx}.
     */
    private Timer mCycleTimer;
    private TimerTask mCycleTask;

    /**
     * For resuming the cycle, after user touch or click the {@link com.shi.androidstudy.view.slider.Tricks.ViewPagerEx}.
     */
    private Timer mResumingTimer;
    private TimerTask mResumingTask;

    /**
     * If {@link com.shi.androidstudy.view.slider.Tricks.ViewPagerEx} is Cycling
     */
    private boolean mCycling;

    /**
     * Determine if auto recover after user touch the {@link com.shi.androidstudy.view.slider.Tricks.ViewPagerEx}
     */
    ...
    /**
     * {@link com.shi.androidstudy.view.slider.Tricks.ViewPagerEx} transformer time span.
     */
    ...
    /**
     * Visibility of {@link com.shi.androidstudy.view.slider.Indicators.PagerIndicator}
     */
    private PagerIndicator.IndicatorVisibility mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;

    /**
     * {@link com.shi.androidstudy.view.slider.Tricks.ViewPagerEx} 's transformer
     */
    private BaseTransformer mViewPagerTransformer;

    /**
     * @see com.shi.androidstudy.view.slider.Animations.BaseAnimationInterface
     */
    private BaseAnimationInterface mCustomAnimation;

    /**
     * {@link com.shi.androidstudy.view.slider.Indicators.PagerIndicator} shape, rect or oval.
     */
     ...
     * {@link com.shi.androidstudy.view.slider.Animations.BaseAnimationInterface},
     * and you can see a example in {@link com.shi.androidstudy.view.slider.Animations.DescriptionAnimation}
     * @param animation
     */
    ...
    /**
     * get the {@link com.shi.androidstudy.view.slider.Indicators.PagerIndicator} instance.
