...
import com.shi.androidstudy.view.charting.interfaces.datasets.ILineScatterCandleRadarDataSet;
...
public abstract class LineScatterCandleRadarDataSet<T extends Entry> extends BarLineScatterCandleBubbleDataSet<T> implements ILineScatterCandleRadarDataSet<T> {
    ...
    /**
     * Sets the width of the highlight menu_line in dp.
     * @param width
     */
    ...
    /**
     * Enables the highlight-menu_line to be drawn in dashed mode, e.g. like this "- - - - - -"
     *
     * @param lineLength the length of the menu_line pieces
     * @param spaceLength the length of space inbetween the menu_line-pieces
    ...
    /**
     * Disables the highlight-menu_line to be drawn in dashed mode.
     */
    ...
    /**
     * Returns true if the dashed-menu_line effect is enabled for highlight lines, false if not.
     * Default: disabled
     *
     * @return
     */
