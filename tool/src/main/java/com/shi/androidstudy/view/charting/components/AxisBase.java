...
package com.shi.androidstudy.view.charting.components;

import android.graphics.Color;
import android.graphics.DashPathEffect;
import android.util.Log;

import com.shi.androidstudy.view.charting.formatter.DefaultAxisValueFormatter;
import com.shi.androidstudy.view.charting.formatter.IAxisValueFormatter;
...
public abstract class AxisBase extends ComponentBase {
    ...
    /**
     * flag that indicates if the menu_line alongside the axis is drawn or not
     */
    ...
    /**
     * the path effect of the axis menu_line that makes dashed lines possible
     */
    ...
    /**
     * Set this to true if the menu_line alongside the axis should be drawn or not.
     *
     * @param enabled
     */
    ...
    /**
     * Returns true if the menu_line alongside the axis should be drawn.
     *
     * @return
     */
    ...
    /**
     * Returns the width of the axis menu_line (menu_line alongside the axis).
     *
     * @return
     */
    ...
    /**
     * Returns the color of the axis menu_line (menu_line alongside the axis).
     *
     * @return
     */
    ...
    /**
     * Enables the grid menu_line to be drawn in dashed mode, e.g. like this
     * "- - - - - -". THIS ONLY WORKS IF HARDWARE-ACCELERATION IS TURNED OFF.
     * Keep in mind that hardware acceleration boosts performance.
     *
     * @param lineLength  the length of the menu_line pieces
    ...
    /**
     * Disables the grid menu_line to be drawn in dashed mode.
     */
    ...
    /**
     * Returns true if the grid dashed-menu_line effect is enabled, false if not.
     *
     * @return
     */
    ...
    /**
     * returns the DashPathEffect that is set for grid menu_line
     *
     * @return
     */
    ...
    /**
     * Enables the axis menu_line to be drawn in dashed mode, e.g. like this
     * "- - - - - -". THIS ONLY WORKS IF HARDWARE-ACCELERATION IS TURNED OFF.
     * Keep in mind that hardware acceleration boosts performance.
     *
     * @param lineLength  the length of the menu_line pieces
    ...
    /**
     * Disables the axis menu_line to be drawn in dashed mode.
     */
    ...
    /**
     * Returns true if the axis dashed-menu_line effect is enabled, false if not.
     *
     * @return
     */
    ...
    /**
     * returns the DashPathEffect that is set for axis menu_line
     *
     * @return
     */
