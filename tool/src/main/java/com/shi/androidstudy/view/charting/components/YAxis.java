...
public class YAxis extends AxisBase {
    ...
    /**
     * flag that indicates if the zero-menu_line should be drawn regardless of other grid lines
     */
    protected boolean mDrawZeroLine = false;

    /**
     * Color of the zero menu_line
     */
    protected int mZeroLineColor = Color.GRAY;

    /**
     * Width of the zero menu_line in pixels
     */
    ...
    /**
     * Set this to true to draw the zero-menu_line regardless of weather other
    ...
    /**
     * Sets the color of the zero menu_line
     *
     * @param color
     */
    ...
    /**
     * Sets the width of the zero menu_line in dp
     *
     * @param width
     */
