...
import com.shi.androidstudy.view.charting.listener.PieRadarChartTouchListener;
...
public abstract class PieRadarChartBase<T extends ChartData<? extends IDataSet<? extends Entry>>>
    ...
    public boolean onTouchEvent(MotionEvent event) {
        // use the menu_circle- and radarchart listener own listener
    ...
    /**
     * gets the raw version of the current rotation angle of the menu_circle chart the
    ...
    /**
     * gets a normalized version of the current rotation angle of the menu_circle chart,
    ...
    /**
     * returns the diameter of the menu_circle- or radar-chart
     *
     * @return
     */
