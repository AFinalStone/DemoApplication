 ...
 */
public class SneakBer {

    final Params params;
    boolean isShowing;

    private SneakBer(@NonNull Params params) {
        this.params = params;
    }
    ...
    public static class CallbackAdapter {
        public void onClick(SneakBer sneakBer) {
        }

        public void onDismiss(SneakBer sneakBer) {
        }
    }
    ...
    public static class Builder {
        ...
        Builder(@NonNull Activity activity) {
            if (Params.EDGE_PADDING == 0 && Params.CONTENT_HEIGHT == 0 &&
                ...
                throw new IllegalArgumentException("please invoke method 'SneakBer.setDisplayConfigs()' set display config first ~");
            }
        ...
        public SneakBer create() {
            final SneakBer sneakBer = new SneakBer(p);
            // Main layout
            ...
            public void run() {
                if (isShowing && !params.activity.isFinishing()) {
                    ...
                    if (params.mListener != null) {
                        params.mListener.onDismiss(SneakBer.this);
                    }
                }
            }
        }, delayMillis);
