...
//        Glide.with(this).load(url01).into(imageView);
        Glide.with(MainActivity.this).load(url01).diskCacheStrategy(DiskCacheStrategy.SOURCE).
                into(new GlideDrawableImageViewTarget(imageView, 2));
        Glide.with(MainActivity.this).load(url02).diskCacheStrategy(DiskCacheStrategy.SOURCE).
                into(new GlideDrawableImageViewTarget(imageView02, 2));
