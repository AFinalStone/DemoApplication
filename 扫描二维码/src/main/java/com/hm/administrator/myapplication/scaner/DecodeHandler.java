package com.hm.administrator.myapplication.scaner;
...
import com.hm.administrator.myapplication.MainActivity;
import com.hm.administrator.myapplication.R;
...
final class DecodeHandler extends Handler {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            Message message = Message.obtain(((MainActivity)activity).getHandler(), R.id.decode_succeeded, rawResult);
            ...
            Message message = Message.obtain(((MainActivity)activity).getHandler(), R.id.decode_failed);
            message.sendToTarget();
        }
    }
