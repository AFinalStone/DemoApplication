package com.shi.androidstudy.tool.statebar;
...
public class StateBarUtil {
    ...
    private StateBarUtil(Activity activity) {
     ...
     */
    public static StateBarUtil with(Activity activity) {
        return new StateBarUtil(activity);
    }
     ...
     * @return the immersion bar
     */
    public StateBarUtil transparentStatusBar() {
     ...
     * @return the immersion bar
     */
    public StateBarUtil transparentNavigationBar() {
     ...
     * @return the immersion bar
     */
    public StateBarUtil transparentBar() {
        mBarParams.statusBarColor = Color.TRANSPARENT;
        mBarParams.navigationBarColor = Color.TRANSPARENT;
        mBarParams.navigationBarColorTem = mBarParams.navigationBarColor;
        mBarParams.fullScreen = true;
     ...
     * @return the immersion bar
     */
    public StateBarUtil statusBarColor(@ColorRes int statusBarColor) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil statusBarColor(String statusBarColor) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil statusBarColorInt(@ColorInt int statusBarColor) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil navigationBarColor(@ColorRes int navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil navigationBarColor(String navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil navigationBarColorInt(@ColorInt int navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil barColor(@ColorRes int barColor) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil barColor(@ColorRes int barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil barColor(String barColor) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil barColor(String barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil barColorInt(@ColorInt int barColor) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil barColorInt(@ColorInt int barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
        mBarParams.statusBarColor = barColor;
        mBarParams.navigationBarColor = barColor;
        mBarParams.navigationBarColorTem = mBarParams.navigationBarColor;
     ...
     * @return the immersion bar
     */
    public StateBarUtil statusBarColorTransform(@ColorRes int statusBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil statusBarColorTransform(String statusBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil statusBarColorTransformInt(@ColorInt int statusBarColorTransform) {
        mBarParams.statusBarColorTransform = statusBarColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public StateBarUtil navigationBarColorTransform(@ColorRes int navigationBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil navigationBarColorTransform(String navigationBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil navigationBarColorTransformInt(@ColorInt int navigationBarColorTransform) {
        mBarParams.navigationBarColorTransform = navigationBarColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public StateBarUtil barColorTransform(@ColorRes int barColorTransform) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil barColorTransform(String barColorTransform) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil barColorTransformInt(@ColorInt int barColorTransform) {
        mBarParams.statusBarColorTransform = barColorTransform;
        mBarParams.navigationBarColorTransform = barColorTransform;
        return this;
    }
     ...
     * 颜色变换支持View
     *
     * @param view the widget
     * @return the widget transform color
     */
    public StateBarUtil setViewSupportTransformColor(View view) {
     ...
     * @return the widget transform color
     */
    public StateBarUtil setViewSupportTransformColor(View view, @ColorRes int viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil setViewSupportTransformColor(View view, @ColorRes int viewColorBeforeTransform,
     ...
     * @return the widget transform color
     */
    public StateBarUtil setViewSupportTransformColor(View view, String viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil setViewSupportTransformColor(View view, String viewColorBeforeTransform,
     ...
     * @return the widget transform color
     */
    public StateBarUtil setViewSupportTransformColorInt(View view, @ColorInt int viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil setViewSupportTransformColorInt(View view, @ColorInt int viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public StateBarUtil addViewSupportTransformColor(View view) {
     ...
     *
     * @param view                    the widget
     * @param viewColorAfterTransform the widget color after transform
     * @return the immersion bar
     */
    public StateBarUtil addViewSupportTransformColor(View view, @ColorRes int viewColorAfterTransform) {
     ...
     *
     * @param view                     the widget
     * @param viewColorBeforeTransform the widget color before transform
     * @param viewColorAfterTransform  the widget color after transform
     * @return the immersion bar
     */
    public StateBarUtil addViewSupportTransformColor(View view, @ColorRes int viewColorBeforeTransform,
                                                     @ColorRes int viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil addViewSupportTransformColor(View view, String viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil addViewSupportTransformColor(View view, String viewColorBeforeTransform,
                                                     String viewColorAfterTransform) {
        return this.addViewSupportTransformColorInt(view,
                Color.parseColor(viewColorBeforeTransform),
                Color.parseColor(viewColorAfterTransform));
     ...
     * @return the immersion bar
     */
    public StateBarUtil addViewSupportTransformColorInt(View view, @ColorInt int viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil addViewSupportTransformColorInt(View view, @ColorInt int viewColorBeforeTransform,
                                                        @ColorInt int viewColorAfterTransform) {
        Map<Integer, Integer> map = new HashMap<>();
     ...
     * @return the immersion bar
     */
    public StateBarUtil removeSupportView() {
        mBarParams.view = null;
        return this;
    }

    /**
     * Remove support widget immersion bar.
     *
     * @param view the widget
     * @return the immersion bar
     */
    public StateBarUtil removeSupportView(View view) {
        if (view != null) {
    ...
    /**
     * Remove support all widget immersion bar.
     *
     * @return the immersion bar
     */
    public StateBarUtil removeSupportAllView() {
     ...
     * @return the immersion bar
     */
    public StateBarUtil fullScreen(boolean isFullScreen) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil statusBarAlpha(@FloatRange(from = 0f, to = 1f) float statusAlpha) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil navigationBarAlpha(@FloatRange(from = 0f, to = 1f) float navigationAlpha) {
        mBarParams.navigationBarAlpha = navigationAlpha;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public StateBarUtil barAlpha(@FloatRange(from = 0f, to = 1f) float barAlpha) {
        mBarParams.statusBarAlpha = barAlpha;
        mBarParams.navigationBarAlpha = barAlpha;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public StateBarUtil statusBarDarkFont(boolean isDarkFont) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil hideBar(BarHide barHide) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil fitsSystemWindows(boolean fits) {
     ...
     * @return the immersion bar
     */
    public StateBarUtil statusBarView(View view) {
     ...
     *
     * @param viewId the widget id
     * @return the immersion bar
     */
    public StateBarUtil statusBarView(@IdRes int viewId) {
    ...
    private void MIUISetStatusBarLightMode() {
        if (mWindow != null) {
            ...
            try {
                int darkModeFlag = 0;
                Class layoutParams = Class.forName("android.widget.MiuiWindowManager$LayoutParams");
