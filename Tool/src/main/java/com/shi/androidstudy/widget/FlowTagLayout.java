...
public class FlowTagLayout extends ViewGroup {
    ...
    /**
     * The adapter containing the data to be displayed by this widget
     */
    ...
    private void reloadData() {
        ...
        for (int i = 0; i < mAdapter.getCount(); i++) {
            ...
            addView(childView, new MarginLayoutParams(MarginLayoutParams.MATCH_PARENT, MarginLayoutParams.MATCH_PARENT));
