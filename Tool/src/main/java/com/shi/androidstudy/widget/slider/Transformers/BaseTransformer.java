package com.shi.androidstudy.widget.slider.Transformers;
 ...
 *
 * BaseTransformer implement {@link com.shi.androidstudy.widget.slider.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link com.shi.androidstudy.widget.slider.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link com.shi.androidstudy.widget.slider.Animations.BaseAnimationInterface}
 * work.
 *
...
public abstract class BaseTransformer implements ViewPagerEx.PageTransformer {
    ...
    /**
     * Indicates if the default animations of the widget pager should be used.
     *
     * @return
     */
